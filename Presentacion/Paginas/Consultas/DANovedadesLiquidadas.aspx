<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="DANovedadesLiquidadas.aspx.cs" Inherits="DANovedadesLiquidadas" %>
            ...
            <div align="center" style="width: 98%; margin: 0px auto">
                <div style="text-align: left; margin-bottom: 10px">
                    <div class="TituloServicio" style="margin-top: 0px">
                        Novedades Liquidadas</div>
                </div>
                <uc2:Prestador ID="ctr_Prestador" runat="server" />
                <uc4:ControlArchivos ID="ctr_Archivos" runat="server" />
                <uc5:ControlBusqueda ID="ctr_Busqueda" runat="server" MostrarCriterio="true" 
                    MostrarMensual="true" MostrarFechas="false" 
                    TraerSoloLosLiquidados="True" />
                        ...
                        <td align="center" colspan="2">
                            <asp:DataGrid ID="dgResultado" runat="server" Width="100%" AllowPaging="True" PageSize="20"
                                ...
                                <Columns>
                                  ...
                                  <asp:BoundColumn DataField="" HeaderText="Importe" DataFormatString="{0:N2}">
									<ItemStyle HorizontalAlign="Right" ></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="" HeaderText="Imp. Desc." DataFormatString="{0:N2}">
									<ItemStyle HorizontalAlign="Right"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="" HeaderText="Cuota Desc.">
