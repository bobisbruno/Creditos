<%@ Page Title="" Language="C#" AutoEventWireup="true"
    CodeFile="Error.aspx.cs" Inherits="Paginas_Varios_Error" %>
              ...
              <div style="width: 95%; height: 95%; margin-top: 20px" class="FondoClaro">
                <div style="padding: 20px 10px 10px 10px; margin-bottom: 20px">
                    <p class="TextoNegroBoldCENTER">
                        <img src="../../App_Themes/Imagenes/atencion_gde.gif " alt="Reloj" width="36" height="36" /></p>
                    <p class="TextoNegroBoldCENTER">
                        Disculpe, este servicio no está disponible en este momento.</p>
                    <span class="TextoNegroBoldCENTER">
                        <br />
                    </span><span class="TextoNegroCENTER">
                        <br />
                        Se ha producido un error en la aplicaci&oacute;n.<br />
                        <br />
                        Por favor reintente en unos segundos y si el problema persiste
                        <br />
                        comun&iacute;quese con la mesa de ayuda al 130.</span><br />
                </div>
            </div>
            <div id="footer">
                <p>
