<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Solicitud_Solo_Tarjeta_Innominada.aspx.cs" Inherits="Paginas_Impresion_Solicitud_Solo_Tarjeta_Innominada" %>
    ...
    <script type="text/javascript" language="javascript" src="<% = ResolveClientUrl("~/Controles/Controles.js") %>"></script>
     <asp:HiddenField ID="hd_esAnses" runat="server" />
      <div class="noPrint" style="text-align: center">
        ...
        <input id="txt_ncopias" type="text" value="4" maxlength="2" style="text-align: center;
