<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Imprimir_DetalleCtaCte.aspx.cs"
    Inherits="Paginas_Impresion_Imprimir_DetalleCtaCte" %>
            ...
            <div class="Cabecera">
                <table style="margin: 0px auto; width: 98%; background-color: #ffffff">
                    ...
                    <tbody style="display: table-footer-group;">
                        ...
                        <tr runat="server" id="tr_Siniestro">
                            <td>
                                <span class="titulo">Siniestro Cobrado</span>
                                <div id="div_Siniestro"  runat="server" style="text-align:left; margin:10px auto">
                                </div>
                            </td>
                        </tr>
                        <tr runat="server" id="tr_cancelacion">
                            <td>
                                <span class="titulo">Cancelación Anticipada</span>
                                <div id="div_CancelacionAnticipada"  runat="server" style="text-align:left; margin:10px auto">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <span class="titulo">Detalle de las Cuotas</span>
                                <div id="div_impresion_cuerpo"  runat="server" style="text-align:center; margin:10px auto">
                                </div>
                            </td>
                        </tr>
                    </tbody>
