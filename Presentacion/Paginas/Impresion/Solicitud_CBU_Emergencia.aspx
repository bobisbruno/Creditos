<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Solicitud_CBU_Emergencia.aspx.cs" Inherits="Paginas_Impresion_Solicitud_CBU_Emergencia" %>
...
<body>
    ...
    <div class="noPrint" style="text-align:center">
     <button id="btn_Imprimir" runat="server" style="margin: 0px 20px 0px auto" onclick="javascript:imprimo()">
      Imprimir</button>
      Nro. Copias a imprimr: <input id="txt_ncopias" type="text" value="1" maxlength="2" style="text-align:center; width:20px" onkeypress="return validarNumeroControl(event)" runat="server" />
    ...
    <div class="miCont">
        <div class="cuep">
             <h1 style="text-align: center; margin-top: 10px">
                Programa de Créditos para Jubilados y Pensionados</br>
                Línea de créditos para damnificados por las inundaciones
            </h1>
            <h1 style="text-align: center; margin-top: 10px">
            ...
            <p>
                ...
                domicilio en la calle Tucumán Nº 500, Ciudad Autónoma de Buenos Aires, me otorgue un Préstamo Personal por la suma de 
                Pesos <asp:Label ID="lbl_Importe_texto" CssClass="TextoBlock" runat="server" Style="margin-left: 3px; margin-right: 3px"></asp:Label>
                ...
                cuotas mensuales y consecutivas, bajo las siguientes condiciones financieras:
            </p>
            ...
            <div class="TextoBlock" style="text-align:center">
               Detalle de primer cuota del préstamo
            </div>
            <asp:DataGrid ID="dg_Cuotas" CssClass="Grilla" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    <asp:BoundColumn DataField="Intereses" HeaderText="Interés" DataFormatString="{0:###,##0.00}"></asp:BoundColumn>
                    ...
                    <asp:BoundColumn DataField="Seguro_Vida" HeaderText="Seguro Vida Mensual" DataFormatString="{0:###,##0.00}"></asp:BoundColumn>
                    <asp:BoundColumn DataField="Importe_Cuota" HeaderText="Cuota Total Mensual" DataFormatString="{0:###,##0.00}"></asp:BoundColumn>
                </Columns>
                <HeaderStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                    Font-Underline="False" HorizontalAlign="Center" />
            </asp:DataGrid>
            <p>
               A fin de proceder a la amortización del capital del préstamo, sus intereses y cargo de seguro de vida, presto formal y 
               expresa conformidad (conf. art. 14 inc. b) último párrafo, Ley N° 24.241) para la afectación del haber neto de la/s 
               prestación/es previsional/es que percibo del SISTEMA INTEGRADO PREVISIONAL ARGENTINO (SIPA) por hasta 
               el porcentual máximo de ley.          
            </p>
            <div>
            ...
            <table id="tbl_Solicitante" class="tbl tabla" style="width: 100%; margin: 0px auto 20px"
                ...
                <tr id="tr_Trajeta">
                    <td colspan="2">
                        Modalidad de desembolso:<b>&quot;CBU de cuenta sueldo&quot;</b>
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%">
            ...
            <p>
                <b>Seguro de vida.</b> Presto expresa conformidad para ser incorporado a la póliza de seguro colectivo de vida que sobre el saldo pendiente de pago del crédito - cancelatorio de deuda -, contrate la ANSES con la compañía de seguros que ella determine. En tales términos, asumo el pago de las primas del seguro durante la vigencia del crédito, previendo que, sujeto a las condiciones estipuladas en la póliza, en caso de mi fallecimiento, el saldo de deuda vigente sea cancelado mediante la aplicación del seguro colectivo de vida contratado.
            </p>
        </div>
    
        <div class="cuep">
            <p style="margin-top: 10px">
                <b>Modalidad de desembolso.</b> Consiento que el monto total del crédito otorgado sea acreditado en mi cuenta de la seguridad social.
            </p>
            <p style="margin-top: 10px">
                <b>Refinanciación.</b> Acepto que, en caso de que, en virtud de orden judicial expresa, no se pudiera realizar uno o más descuentos, ANSES establezca un plan para refinanciar los saldos adeudados.
            </p>
            <p style="margin-top: 10px">
                <b>Falta de pago.</b> En caso de que la ANSES no perciba los montos adeudados, por cualquier razón ajena al obrar de dicho organismo, o por haberse modificado el haber del solicitante por causas ajenas a la ANSES, acepto cancelar dichas obligaciones en la forma en que el mismo determine. Sólo me liberaré de mi obligación personal de pago en la medida de la cancelación efectiva de los montos adeudados a favor de la ANSES.
            </p>
            <p style="margin-top: 10px">
                <b>Imputación de pagos.</b> Consiento que la imputación de pagos se realice de la siguiente forma: (i) seguro colectivo de vida; (ii) interés y (ii) capital, en ese orden. 
            </p>
            <p style="margin-top: 10px">
                <b>Gastos a cargo del solicitante.</b> Asumo el pago de todo gasto o pérdida en que pudiera incurrir la ANSES como consecuencia del incumplimiento del pago de las sumas adeudadas y/o cualquier suma pagadera en virtud del préstamo.
            </p>
            <p style="margin-top: 10px">
                <b>Habeas Data.</b> Declaro saber que, en cumplimiento de la LEY DE HABEAS DATA y reglamentarias, mis datos personales y patrimoniales relacionados con la operación crediticia que solicito realizar podrán ser informados y registrados en la base de datos de las organizaciones de información crediticia, públicas y/o privadas.
            </p>
            <p style="margin-top: 10px">
             Solicito a la ANSES se sirva acusar recibo de la presente solicitud de préstamo firmando los espacios previstos para ello, al solo efecto de identificarla, sin que ello importe aceptación de la misma.
             Oportunamente, se tendrá como prueba y manifestación del consentimiento de la ANSES a todos los términos contenidos en esta SOLICITUD -incluyendo este párrafo- a la acreditación de la suma solicitada en préstamo en mi cuenta de la seguridad social. Una vez efectuada dicha acreditación, el contrato propuesto mediante la presente tendrá plena vigencia.
            </p>
        </div>
                    ...
                    <table style="width: 100%; text-align: center">
                        <tr>
                            <td style="border-width:1px; border-style:dashed;border-color:Black; width:80%" >
                                <p style="margin:5px" >
                                    Se recibe el original de la presente SOLICITUD al solo efecto de su
                                    consideración, a los <asp:Label ID="lbl_dia" runat="server" CssClass="TextoBlock"></asp:Label> 
                                    días del mes de <asp:Label ID="lbl_Mes" runat="server" CssClass="TextoBlock"></asp:Label> de 
                                ...
                                <div style="border-width:1px; border-top-style:dashed; font-size:9px"><asp:Label ID="lbl_pieTipo" runat="server"></asp:Label></div>
                                <table cellpadding="0" cellspacing="0" style="width: 250px; border: 1px solid #000;
                                    ...
                                    <tr>
                                        <td style="border-top: 1px solid #000 font-size:9px">
                                            <asp:Label ID="lbl_piePerAutorizado" runat="server"/>: <asp:Label ID="lbl_Operador" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                                <span style="font-size: 8px; text-align:center"><asp:Label ID="lbl_pieFirmaSello" runat="server"/></span>
                            </td>                    
                            <td style="" >
