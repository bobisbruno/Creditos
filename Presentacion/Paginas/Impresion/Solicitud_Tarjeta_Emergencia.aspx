<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Solicitud_Tarjeta_Emergencia.aspx.cs" Inherits="Paginas_Impresion_Solicitud_Tarjeta_Emergencia" Theme="impresion" %>
      ...
      <div  class="miCont">
        <div class="cuep">
             <h1 style="text-align: center; margin-top: 10px">
                Tarjeta ARGENTA – Programa de Créditos para Jubilados y Pensionados</br>
            ...
            <table class="tbl tabla" style="width: 100%; margin: 5px auto;"  cellspacing="0">                  
                <tr>
                    <td>
            ...
            <table id="tbl_Solicitante" class="tbl tabla" style="width: 100%; margin: 5px auto;"  cellspacing="0">
                ...
                <tr id="tr_Trajeta">
                    <td colspan="2">
                        Modalidad de desembolso:<b>TARJETA ARGENTA SOLIDARIA</b>
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%">
        ...
        <div class="cuep" runat="server" id="div_DesarrolloPrestamo">
                ...
                <asp:DataGrid ID="dg_Cuotas_Correo" CssClass="Grilla" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="Gastos_Admin" HeaderText="Gastos Admin." DataFormatString="{0:###,##0.00}">
                        </asp:BoundColumn>
        ...
        <div class="cuep">
            ...
            <h1 style="text-align: center; margin-top: 10px">
                <u>Constancia de emisión de crédito.</u>
            </h1>
            <div>
                Datos del Solicitante:
            </div>
            <table id="Table1" class="tbl tabla" style="width: 100%; margin: 0px auto 20px"
                ...
                <tr>
                    <td colspan="2">
                        Apellido y Nombre:
                        <asp:Label ID="lbl_Apellido_Constancia" runat="server" CssClass="TextoBlock"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%">
                        Beneficio N°:<asp:Label ID="lbl_N_Beneficio_Constancia" runat="server" Style="margin-left: 1px;" CssClass="TextoBlock"></asp:Label>
                    </td>
                    <td>
                        CUIL N°:
                        <asp:Label ID="lbl_CUIL_Constancia" runat="server" Style="margin-left: 1px;" CssClass="TextoBlock"></asp:Label>
                    </td>
                </tr>
                <tr id="tr1">
                    <td colspan="2">
                ...
                <tr>
                    <td style="width: 50%">
                        Domicilio:
                        <asp:Label ID="lbl_Domicilio_Constancia" runat="server" Style="margin-left: 1px; " CssClass="TextoBlock"></asp:Label>
                        CP: <asp:Label ID="lbl_CP_Constancia" runat="server" CssClass="TextoBlock"></asp:Label>
                    </td>
                    <td>
                        Localidad:
                        <asp:Label ID="lbl_Localidad_Constancia" runat="server" CssClass="TextoBlock"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                        Provincia:
                        <asp:Label ID="lbl_Provincia_Constancia" runat="server" CssClass="TextoBlock"></asp:Label>
                    </td>
                       <td colspan="2">Correo electrónico:
                    <asp:Label ID="lbl_Mail_Constancia" runat="server" CssClass="TextoBlock"></asp:Label>
                    </td>
                ...
                <tr>
                    <td>
                        Teléfono:
                        <asp:Label ID="lbl_Telefono1_Constancia" runat="server" CssClass="TextoBlock"></asp:Label>
                    </td>
                    <td>
                        Teléfono:
                        <asp:Label ID="lbl_Telefono2_Constancia" runat="server" CssClass="TextoBlock"></asp:Label>
                    </td>
               </tr>
            </table>
            <p>
                Recibo la presente constancia a los efectos de su presentación, junto con la Tarjeta ARGENTA y su documento nacional de identidad, en los comercios adheridos al Programa ARGENTA que explícitamente ofrezcan descuentos especiales para los titulares de créditos de la Línea de créditos para damnificados por las inundaciones.
            </p>
            <p>
                El detalle y la vigencia de los descuentos especiales serán informados por los comercios adheridos y la ANSES.
            </p>
        </div>  
       ...
       <div runat="server" id="div_ConsImpedimentoFirma" visible="false" class="">
               ...
               <div id="div_SaltoPagina" class="SaltoPagina"></div>              
            </div> 
