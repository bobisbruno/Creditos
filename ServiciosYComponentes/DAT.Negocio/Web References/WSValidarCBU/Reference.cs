...
namespace Anses.DAT.Negocio.WSValidarCBU {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="ValidarCBUSoap", Namespace="http://tempuri.org/")]
    public partial class ValidarCBU : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public ValidarCBU() {
            this.Url = global::Anses.DAT.Negocio.Properties.Settings.Default.Anses_DAT_Negocio_WSValidarCBU_ValidarCBU;
        ...
        public Retorno Validar(string Cuil, string CBU) {
        ...
        /// <remarks/>
        public void ValidarAsync(string Cuil, string CBU) {
            this.ValidarAsync(Cuil, CBU, null);
        }
        
        /// <remarks/>
        public void ValidarAsync(string Cuil, string CBU, object userState) {
            ...
            this.InvokeAsync("Validar", new object[] {
                        Cuil,
                        CBU}, this.ValidarOperationCompleted, userState);
        }
