...
namespace ANSES.Microinformatica.DATws
{
	...
	public class NovedadWS : System.Web.Services.WebService
	{
...

		{
			...
			try
			{
				...
				return oNov.Novedades_Trae_NoAplicadas(OpcionBusqueda, idPrestador, benefCuil, tipoConc, concopp,fdesde, fhasta, GeneraArchivo,mensual,out rutaArchivoSal, Usuario);
			}
			catch (Exception err)
			{
				throw err;
...

	{
		...
		public string Novedades_T3_Alta_ConTasa(long IdPrestador, long IdBeneficiario, DateTime FecNovedad,  byte TipoConcepto, int ConceptoOPP, 
			...
			string nroSocio, int idDomicilioBeneficiario,int idDomicilioPrestador, byte idTipoDocPresentado, DateTime fEstimadaEntrega, bool solicitaTarjetaNominada)
		{
			...
			return Novedades_T3_Alta_ConTasa_Sucursal(IdPrestador, IdBeneficiario, FecNovedad, TipoConcepto, ConceptoOPP, 
													...
													string.Empty, DateTime.MinValue,DateTime.MinValue, idTipoDocPresentado, fEstimadaEntrega, solicitaTarjetaNominada);
