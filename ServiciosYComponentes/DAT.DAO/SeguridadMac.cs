...
namespace ANSES.Microinformatica.Lib.Seguridad
{
    ...
    public class CrytoNet
    {
        ...
        public static string MacSHA1(string dato, string clave)
        {
        ...
        public static string MacSHA1(DataSet DSdato, string clave)
        {
        ...
        public static string Mac3Des(string dato, string clave)
        {
            UTF8Encoding utf = new UTF8Encoding();
        ...
        public static string Mac3Des(DataSet DSdato, string clave)
        {
            string dato = DSdato.GetXml();
        ...
        private static string toHexa(byte[] arreglo)
        {
            string salida = "";
            string strhex = "";
